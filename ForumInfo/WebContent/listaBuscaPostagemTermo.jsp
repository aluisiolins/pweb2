...
<body>
	...
	<h2>Página - Listagem de Postagens (Busca/Termo)</h2>
	
	<%
		List<Postagem> listaTemp2= (List<Postagem>)request.getAttribute("listaTermo");
	%>
		<table border="1">
		  <tr bgcolor="#eaeaea">
		    <th>Idt:</th>
	...
	<tr>
		    ...
		    <td><input type="radio" name="ref" value="<%=p.getId()%>"></td>
		    <td><a href="cadComentario.jsp?ident=<%=p.getId()%>"> Comentar =></a></td> 
